...
const { semver } = __nccwpck_require__(3628);
...
const utils = __nccwpck_require__(3837);
const fs = __nccwpck_require__(7147);
const core = __nccwpck_require__(2186);

const { parseEntry } = __nccwpck_require__(2280);
const { getEntries } = __nccwpck_require__(1964);
const { getVersionById } = __nccwpck_require__(8012);
